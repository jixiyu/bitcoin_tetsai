...
std::string LicenseInfo()
{
    ...
    return FormatParagraph(strprintf(_("Copyright (C) 2017-%i The Catcoin Core Developers"), COPYRIGHT_YEAR)) + "\n" +
           "\n" +
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    try {
        ...
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s. Catcoin Core is probably already running.") + " %s.", strDataDir, e.what()));
    }
